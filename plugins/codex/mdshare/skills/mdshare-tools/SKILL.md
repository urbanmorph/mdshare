...
mdshare is a free, no-login markdown sharing service at mdshare.live. This skill orchestrates 14 MCP tools that let Codex upload, read, edit, comment on, and version markdown documents.
...
- The user wants Codex to read or edit local markdown files (use the standard file tools)
- The user wants to configure Codex with markdown context (AGENTS.md territory — different concept)
