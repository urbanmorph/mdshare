...
const cases: Array<{
  ...
  lang: string;
  ogLocale: string;
  font: RegExp | null; // expected family slug in fontHref, or null (no extra load)
}> = [
  { name: "arabic", text: "مرحبا بك في هذا المستند التقني", script: "arabic", dir: "rtl", lang: "ar", ogLocale: "ar_AR", font: /Noto\+Naskh\+Arabic/ },
  { name: "hebrew", text: "שלום עולם וברוך הבא למסמך", script: "hebrew", dir: "rtl", lang: "he", ogLocale: "he_IL", font: /Noto\+Sans\+Hebrew/ },
  { name: "cyrillic", text: "Техническая спецификация документа", script: "cyrillic", dir: "ltr", lang: "ru", ogLocale: "ru_RU", font: /Noto\+Sans/ },
  { name: "chinese", text: "技术规格说明书文档资料", script: "han", dir: "ltr", lang: "zh", ogLocale: "zh_CN", font: /Noto\+Sans\+SC/ },
  { name: "japanese", text: "技術仕様書類管理 かな", script: "japanese", dir: "ltr", lang: "ja", ogLocale: "ja_JP", font: /Noto\+Sans\+JP/ },
  { name: "korean", text: "기술 사양서 문서입니다", script: "korean", dir: "ltr", lang: "ko", ogLocale: "ko_KR", font: /Noto\+Sans\+KR/ },
  { name: "devanagari", text: "तकनीकी विनिर्देश दस्तावेज़", script: "devanagari", dir: "ltr", lang: "hi", ogLocale: "hi_IN", font: /Noto\+Sans\+Devanagari/ },
  { name: "thai", text: "ข้อกำหนดทางเทคนิคของเอกสาร", script: "thai", dir: "ltr", lang: "th", ogLocale: "th_TH", font: /Noto\+Sans\+Thai/ },
  { name: "greek", text: "Τεχνικές προδιαγραφές εγγράφου", script: "greek", dir: "ltr", lang: "el", ogLocale: "el_GR", font: /Noto\+Sans/ },
  { name: "latin", text: "Technical specification document", script: "latin", dir: "ltr", lang: "en", ogLocale: "en_US", font: null },
];
...
for (const c of cases) {
  test(`detects ${c.name}`, () => {
    ...
    if (c.font === null) {
      assert.equal(info.fontHref, null, "latin must not request an extra font");
    } else {
      assert.match(info.fontHref ?? "", c.font, "fontHref family");
    }
  });
}
...
test("Vietnamese is Latin script → latin/en, no extra font", () => {
  ...
  assert.equal(info.fontHref, null);
});
